...
import { List, ListItem, ListItemButton, ListItemIcon, ListItemText, Collapse, Accordion, AccordionSummary, AccordionDetails, Typography } from '@mui/material';
        ...
        >
            ...
            <ListItem disablePadding>
                <ListItemButton onClick={() => setShowSeries(!showSeries)}>
                    <ListItemText primary="Series and Sets" />
